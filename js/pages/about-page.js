                    ...
                    <div style="padding: 30px;">
                        ...
                        <div style="margin-bottom: 30px;">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 10px;">
                                ...
                                <span style="background: linear-gradient(135deg, #e8f0fe 0%, #d4e4ff 100%); color: #2b5278; padding: 8px 16px; border-radius: 20px;">XMLHttpRequest</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <p style="color: #555; line-height: 1.6;">Все данные о погоде хранятся на сервере и передаются через REST API с использованием <strong>XMLHttpRequest</strong> (GET, POST, PATCH, DELETE).</p>
                        </div>
                    </div>
