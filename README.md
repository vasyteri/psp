# ЛР4. Создание бэкенда на Express.js
...
- [5. Реализация REST API для карточек `Stock`](#5-реализация-rest-api-для-карточек-stock)
- [6. Тестирование работоспособности сервиса с помощью Postman](#6-тестирование-работоспособности-сервиса-с-помощью-postman)
- [7. Дополнительные материалы](#7-дополнительные-материалы)
- [8. Выполненные дополнительные задания](#8-выполненные-дополнительные-задания)
...
## 8. Выполненные дополнительные задания
